...
public class DummyComponentEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        editorTextFieldNoLabel.stringValue = AutoCompleteTextField.EditorGUILayout.AutoCompleteTextField(editorTextFieldNoLabel.stringValue, options, "Type something here too", false, true, false, null, GUILayout.Width(200));
