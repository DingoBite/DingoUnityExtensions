            ...
            IStyle windowStyle, bool returnFullPath = false, Func<string, float> orderFunc = null)
        {
            ...
            if (GUI.GetNameOfFocusedControl().Equals("CheckFocus"))
            {
                ...
                if (fromEditor)
                {
                    ...
                    }, "/", returnFullPath: returnFullPath, allowCustom: allowCustom, allowEmpty: allowEmpty, orderFunc: orderFunc);
#endif
                }
                else
                {
                    ...
                    M_addItemWindow.Show(newRect, entries, new []{ text }, s =>
                    {
                        ...
                        M_returnedValue = true;
                        M_returnedScreenPos = myScreenPos;
                    }, "/", returnFullPath: returnFullPath, allowCustom: allowCustom, style: windowStyle, allowEmpty: allowEmpty, orderFunc: orderFunc);
                }
            }
