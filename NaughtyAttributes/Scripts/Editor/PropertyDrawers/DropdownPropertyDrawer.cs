        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            if (AreValuesValid(valuesObject, dropdownField))
            {
                if (valuesObject is IList && dropdownField.FieldType == GetElementType(valuesObject))
                {
                    ...
                    NaughtyEditorGUI.Dropdown(rect, property.serializedObject, target, dropdownField, dropdownAttribute.IsShowLabel ? label.text : null, selectedValueIndex, values, displayOptions);
                }
